...
public class Constructor {
	...
	/*
	 * 생성자: 객체생성후 최초로 단 한번 호출되는 메쏘드
	 */
	
	public Constructor() {
		System.out.println("Construtor() 기본 생성자 메소드 호출 this주소:"+this);
		this.member1=100;
		this.member2=200;
	}
	public Constructor(int member1, int member2) {
		System.out.println("Constructor(int member1, int member2) 생성자 메소드 호출");
