...
public class AccountServiceMain {
	...
	public static void main(String[] args) {
		...
		accountService.addAccount(new Account(9090, "EQQ", 99999, 9.9));
		accountService.addAccount(9898, "EQQ", 99989, 9.9);
		System.out.println("1.AccountService객체야 은행계좌들 총계좌수출력해줘[OPTION]");
		...
		accountService.ipGum(1111, 6000);
		...
		Account updateAccount = new Account(2222, "TWO", 2000, 2.2); //Data Transfer Object 
